...
for pat in P01* P02* P03* P04*R P05* P07* P10* P14* P15* P16*; do
# for pat in P10* P14* P15* P16*; do
# for pat in P08*; do
    cd ${pat}
    patnum=${pat%%_*}
    temp=${pat/${patnum}_/}
        ...
        for method in "cold_spots"; do
            ...
            # for strat in "free"; do
                ...
                /opt/utils/adaptive-build/adaptive \
                        ...
                        --field_plan_doses ../base_plan/out_base_plan/warped_Dose.dose \
                        --sf_dij 1000000 --sf_dose 1000000 \
                        --sim_adapt  \
